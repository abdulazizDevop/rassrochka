...
function initSchema(db: Database.Database) {
  ...
  if (contractCount === 0) {
    const ins = db.prepare('INSERT INTO contracts (id, number, created_at, end_date, client_id, client_name, product, phone, status, remaining_debt, monthly_payment, payment_status, cost, markup, first_payment, months, source, tariff, account, start_date, pay_day) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)');
    ins.run('1', 1, '03.08.2025', '03.01.2026', '12', 'старый', 'Холодильник', '+7 (444) 444-44-44', 'Погашен', 0, 7800, 'Погашен', 46800, 0, 0, 6, 'Баланс', 'стандарт', 'общий', '03.08.2025', 3);
    ins.run('2', 2, '03.09.2025', '03.06.2026', '4', 'a222 a222 a222', 'Ковер', '+7 (555) 555-55-55', 'Просрочен', 234000, 26000, 'Не оплачено', 156000, 0, 0, 9, 'Баланс', 'стандарт', 'общий', '03.09.2025', 3);
    ins.run('3', 3, '03.11.2025', '03.06.2026', '1', 'a111 a111 a111', 'Телевизор', '+7 (222) 222-22-22', 'Списан', 4287, 18571, 'Оплачено', 130000, 0, 0, 7, 'Баланс', 'стандарт', 'общий', '03.11.2025', 3);
    ins.run('4', 4, '02.01.2026', '02.04.2026', '9', 'пул2 пул2 пул2', 'айфон', '+7 (666) 666-66-66', 'Просрочен', 85800, 42900, 'Оплачено', 85800, 0, 0, 2, 'Баланс', 'стандарт', 'общий', '02.01.2026', 2);
    ins.run('5', 5, '13.02.2026', '13.08.2026', '7', 'нуцалов шамиль', 'телефон айфон', '+7 (928) 504-76-97', 'В процессе', 58500, 19500, 'Оплачено', 117000, 0, 0, 6, 'Баланс', 'стандарт', 'общий', '13.02.2026', 13);
    ins.run('6', 6, '03.03.2026', '03.09.2026', '3', 'a1 a1 a1', 'Айфон', '+7 (111) 111-11-1', 'В процессе', 91000, 15167, 'Новый договор', 91000, 0, 0, 6, 'Баланс', 'стандарт', 'общий', '03.03.2026', 5);
    ins.run('7', 7, '03.03.2026', '03.11.2026', '6', 'a2 a2 a2', 'Айфон', '+7 (222) 222-22-22', 'В процессе', 91000, 11375, 'Новый договор', 91000, 0, 0, 8, 'Баланс', 'стандарт', 'общий', '03.03.2026', 5);
    ins.run('8', 8, '03.03.2026', '03.12.2026', '2', 'a11 a11 a11', 'Айфон', '+7 (222) 222-22-22', 'В процессе', 195000, 21667, 'Новый договор', 195000, 0, 0, 9, 'Баланс', 'стандарт', 'общий', '03.03.2026', 5);
    ins.run('9', 9, '03.03.2026', '03.06.2026', '5', 'a22 a22 a22', 'Айфон', '+7 (333) 333-33-33', 'В процессе', 195000, 65000, 'Новый договор', 195000, 0, 0, 3, 'Баланс', 'стандарт', 'общий', '03.03.2026', 5);
    ins.run('10', 10, '03.03.2026', '03.06.2026', '8', 'пул1 пул1 пул1', 'Айфон', '+7 (555) 555-55-55', 'В процессе', 25000, 13000, 'Новый договор', 25000, 0, 0, 3, 'Баланс', 'стандарт', 'общий', '03.03.2026', 5);
    ins.run('11', 11, '03.03.2026', '03.06.2026', '10', 'пул3 пул3 пул3', 'Ноутбук', '+7 (777) 777-77-77', 'Досрочно погашен', 0, 32500, 'Погашен', 97500, 0, 0, 3, 'Баланс', 'стандарт', 'общий', '03.03.2026', 5);
    ins.run('12', 12, '03.03.2026', '03.06.2026', '11', 'пул4 пул4 пул4', 'Смартфон', '+7 (999) 999-99-99', 'Досрочно погашен', 0, 18571, 'Погашен', 130000, 0, 0, 7, 'Баланс', 'стандарт', 'общий', '03.03.2026', 5);
    ins.run('13', 13, '03.03.2026', '03.06.2026', '7', 'нуцалов шамиль', 'Планшет', '+7 (926) 869-61-69', 'Досрочно погашен', 0, 32500, 'Погашен', 97500, 0, 0, 3, 'Баланс', 'стандарт', 'общий', '03.03.2026', 5);
  }
